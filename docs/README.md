...
| [spec/agent-flavored-markdown-specification.md](spec/agent-flavored-markdown-specification.md) | Reference for the WSO2 Agent-Flavored Markdown (AFM) spec, plus an **Applying AFM to Doxa** section with ready-to-use `.afm.md` agent examples. |
| [MarkdownAgent.md](MarkdownAgent.md) | System-prompt definition for a token-efficient Markdown retrieval agent (metadata-first filtering, summary anchors, minimal-fragment fetching). |
